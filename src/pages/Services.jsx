...
const Services = () => {
    return (
        <>
        <section>
            <img className="img-fluid" src="../../public/banner-Copie.jpg" alt="" />
        </section>
        ...
        <section className="container">
            <div className="row justify-content-center g-3 px-3">
                <Card className="hoverCard mb-md-3 col-12 col-md-4 h-md-75" >
                ...
                <Card className="hoverCard mb-md-3 col-12 col-md-4 " >
                    <Card.Body className="mx-2 d-flex flex-column align-items-center">
                ...
                <Card className="hoverCard mb-5 mb-md-3  col-12 col-md-4" >
                    <Card.Body className="mx-2 d-flex flex-column align-items-center">
