                ...
                <section className="container pt-5">
                    <article className="d-flex flex-column">
                        ...
                        <address className="text-white d-flex flex-column">
                            ...
                            <a className="text-white text-decoration-none" href="tel:0102030405">10 20 30 40 50</a>
                            <a className="text-white text-decoration-none" href="mailto:johndoe@gmail.com">john.doe@gmail.com</a>
                        </address>
                    </article>
                    <article>
                        <a className="text-secondary me-2 hoverSocial" href="https://github.com/CarflyHc" rel="nofollow" target="_blank"> <i className="bi bi-github"></i></a>
                        <a className="text-secondary me-2 hoverSocial" href="https://x.com/?lang=fr&mx=2" rel="nofollow" target="_blank"><i className="bi bi-twitter"></i></a>
                        <a className="text-secondary me-2 hoverSocial" href="https://www.linkedin.com/in/boris-lux-00a330a1/" rel="nofollow" target="_blank"><i className="bi bi-linkedin"></i></a>
                    </article>
                </section>
                <section className="container my-3">
                    <article>
                        ...
                        <ul className="navbar-nav" id="menu">
                            ...
                            <Nav.Item as ="li" className="nav-item">
                                <NavLink to="/Mentions-Legales" className="nav-link link-light p-0 bold">Mentions legales</NavLink>
                            </Nav.Item>
                        </ul>
                    </article>
                </section>
                <section className="container myt-3 pb-4">
                    <article>
